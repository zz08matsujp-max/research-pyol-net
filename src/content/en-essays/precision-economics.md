...
- [Companion essay: §14 Bonnō Embedding and the Scam-Detection Mechanism](/en/essays/bonno-embedding/) — the technical implementation at the heart of the Economies-of-Precision detection stack (Affective Computing + scam detection)
